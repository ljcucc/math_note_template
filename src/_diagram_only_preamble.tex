...
\excludecomment{textAndImageEnv}
\excludecomment{imageAndTextEnv}

\excludecomment{textRight}
\excludecomment{textLeft}

% ========== Someone Said Paragraph Block ==========

\excludecomment{readerSaid}
\excludecomment{teacherSaid}

\newenvironment{readerSaidFigure}{\pagebreak}{}
\newenvironment{teacherSaidFigure}{\pagebreak}{}
